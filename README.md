...
| 名称 | 自己准备证书 | TLSinTLS特征 | 通过CDN访问 | HTTP/2多路复用 | 0-RTT优化 |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Vision** | :heavy_check_mark: | :x: | :x: | :x: | :x: |
| **Vision-REALITY** | :x: | :x: | :x: | :x: | :x: |
| **gRPC-REALITY** | :x: | :heavy_check_mark: | :x: | :heavy_check_mark: | :heavy_check_mark: |
| **H2-REALITY** | :x: | :heavy_check_mark: | :x: | :heavy_check_mark: | :heavy_check_mark: |
