...
[打开链接1](https://github.com/2dust/v2rayN/releases) 点击最新版本栏里的“▸ Assets”，找到名为`v2rayN-Core.zip`的链接并下载。
[打开链接2](https://github.com/XTLS/Xray-core/releases) 点击最新版本栏里的“▸ Assets”，找到名为`Xray-windows-64.zip`的链接并下载。
把2个压缩包解压，把xray.exe复制到`v2rayN-Core`文件夹里，运行`v2rayN.exe`。
